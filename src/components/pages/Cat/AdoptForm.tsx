...
export const AdoptForm: Component<AdoptFormProps> = () => {
  ...
  return (
    <div class="flex flex-col items-start gap-4 relative">
      ...
      <div
        classList={{
          "border-4 border-black rounded-xl bg-pink p-4 md:p-6 overflow-hidden w-full transition-all duration-300":
            true,
          "max-h-14 max-w-64 sm:max-w-[20rem] sm:max-h-20 m-4": !formOpened(),
          "max-w-full max-h-[35rem]": formOpened(),
        }}
      >
        <h2
          classList={{
          ...
          >
            <div class="flex flex-col gap-1">
              ...
              <input
                ...
                placeholder="Maria"
                required
                class="transition-all border-4 border-b-8 focus:border-b-4 focus:mb-1 transform focus:scale-[102%] border-black hover:scale-[99%] hover:shadow-lg focus:shadow-none rounded-xl p-2 text-xl"
              />
            </div>
            <div class="flex flex-col gap-1">
            ...
            <Button variant="form" class="self-start mt-4" type="submit">
              Enviar
            </Button>
          </form>
        )}
