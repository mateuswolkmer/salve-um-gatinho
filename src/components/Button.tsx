...
const buttonVariants = cva(
  "transition-all hover:scale-105 hover:shadow-lg hover:-rotate-1 active:scale-95 :active:shadow-none border-2 [&:not(:disabled)]:border-b-4 [&:not(:disabled)]:active:border-b-2 border-black rounded-xl flex gap-2 group focus:outline-2 focus:outline-offset-2 focus:outline-dashed focus:outline-pink active:outline-none disabled:bg-gray-300 disabled:hover:pointer-events-none",
  {
    variants: {
      variant: {
